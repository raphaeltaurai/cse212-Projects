...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue returns people in the wrong order (LIFO instead of FIFO). Expected Bob, got Sue first.
    ...
    // Defect(s) Found: The queue returns people in the wrong order (LIFO instead of FIFO). Expected Tim, got Sue first.
